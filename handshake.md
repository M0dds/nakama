...
**`REVIEW-2026-07.md`** (Monats-Review, 54 verifizierte Findings + Produkt-Roadmap) ist der aktive Plan. Stand 2026-07-06: **P0 ✓** (C1/C2/U2/C7, Migration `20260703100000` gefahren) · **P1 ✓** (U1-Touch-Paket, U3-Fehler-Karten, U4-Dialog-Fokus, C3/C4, W1) · dazu außerplanmäßig die **Mobile-Session v0.18.0** (AddSheet-Suche mobil neu, Backdrop-Perf, Update-Feedback — siehe §Stand) · **P2 ✓** (2026-07-06: C5 Worker-AniList-Relay raus · C6 Docs-Pass — §Gotchas→iOS/Mobile neu, Cover-/Theme-/Inventar-Sync, Migrationsliste komplett · Code-Health-Audit Stufe 1). **Als Nächstes: P3** (Produkt-Roadmap §4 in Reihenfolge — #1 „Als Nächstes"-Strip zuerst; die Low-Listen aus Review-§2/§3 bleiben als Nach-Gusto-Reservoir).
